...
export class TradeApiService {
  ...
  async getFlashTradeSettings(): Promise<any> {
    return this.client.get<any>('/trade/flash-trade/settings');
  }
  ...
  async getActiveFlashTrades(): Promise<{ trades: any[] }> {
    return this.client.get<{ trades: any[] }>('/trade/flash-trade/active');
  }

  async getFlashTradeHistory(
    params?: PaginationParams
  ): Promise<PaginatedResponse<any>> {
    return this.client.getPaginated<any>('/trade/flash-trade/history', params);
  }
  ...
  async getActiveQuickTrades(): Promise<{ trades: any[] }> {
    return this.client.get<{ trades: any[] }>('/trade/quick-trade/active');
  }
